...
variant_for_slice()
{
  ...
  "OneSignalLiveActivities.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "OneSignalLiveActivities.xcframework/ios-x86_64-maccatalyst")
    echo "maccatalyst"
    ;;
  ...
  "OneSignalOSCore.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "OneSignalOSCore.xcframework/ios-x86_64-maccatalyst")
    echo "maccatalyst"
    ;;
  ...
  "OneSignalUser.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "OneSignalUser.xcframework/ios-x86_64-maccatalyst")
    echo "maccatalyst"
    ;;
  esac
}
...
install_xcframework "${PODS_ROOT}/OneSignal/iOS_SDK/OneSignalSDK/OneSignal_LiveActivities/OneSignalLiveActivities.xcframework" "OneSignal/OneSignalLiveActivities" "framework" "ios-arm64" "ios-arm64_x86_64-simulator" "ios-x86_64-maccatalyst"
...
install_xcframework "${PODS_ROOT}/OneSignal/iOS_SDK/OneSignalSDK/OneSignal_OSCore/OneSignalOSCore.xcframework" "OneSignal/OneSignalOSCore" "framework" "ios-arm64" "ios-arm64_x86_64-simulator" "ios-x86_64-maccatalyst"
...
install_xcframework "${PODS_ROOT}/OneSignal/iOS_SDK/OneSignalSDK/OneSignal_User/OneSignalUser.xcframework" "OneSignal/OneSignalUser" "framework" "ios-arm64" "ios-arm64_x86_64-simulator" "ios-x86_64-maccatalyst"
